                 ...
                 <li key={task.id} className="bg-orange-800 flex justify-between my-2">
                        ...
                        <article>
                            <button 
                                    ...
                                    className={task.completed ? "bg-green-600 border-[1px] border-cyan-950 p-2 m-2" : "bg-gray-900 border-[1px] border-cyan-950 p-2 m-2 hover:bg-green-600"} >
                                <FaCheck />
                            </button>
                            <button 
                                    onClick={() => deleteTask(task.id)} 
                                    className="bg-gray-900 border-[1px] border-cyan-950 p-2 m-2 hover:bg-red-600">
                                <FaRegTrashAlt />
                            </button>
                        </article>
                            </li>
